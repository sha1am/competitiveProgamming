...
void solve() {
...

	{
		...
		// int countOfDelElementsTillNow=0;
		// for(int i=0;i<sizeof(arr)/sizeof(arr[0]);i++){
		// 	if(!(i&1)){
		// 		//delete elements
		// 		arr[i]=-1; // temporary
		// 		countOfDelElementsTillNow+=1;
		// 	}
		// 	else{
		// 		arr[i-countOfDelElementsTillNow]=arr[i];
		// 	}

		// }

		// int newArrSize=sizeof(arr)/sizeof(arr[0])-countOfDelElementsTillNow;
	...
	debug(arr);
	debug((int)arr.size());
	debug((int)sizeof(arr));
	debug((int)sizeof(arr[0]));
	...
	debug(countOfDelElementsTillNow);
	debug((int)sizeof(arr));
	debug((int)sizeof(arr[0]));
	int aa=sizeof(arr)/sizeof(arr[0]);
	debug(aa);
	int newArrSize=sizeof(arr)/sizeof(arr[0])-countOfDelElementsTillNow;
	debug(newArrSize);
